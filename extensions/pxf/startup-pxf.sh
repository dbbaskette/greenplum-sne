...
# Startup script for Greenplum SNE with PXF
# Extends the base startup with PXF initialization

set -e

echo "=== Starting Greenplum SNE with PXF ==="
echo "Timestamp: $(date)"
echo ""
...
sudo -u gpadmin bash -c "
    ...
    echo '✅ Greenplum database with PXF is ready!'
